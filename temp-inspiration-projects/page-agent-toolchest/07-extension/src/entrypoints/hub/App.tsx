...
import { GlassNavbar, Logo, MotionOverlay, StatusDot } from '@/components/misc'
	...
	return (
		<div className="flex h-screen bg-background">
			...
			<aside className="w-80 shrink-0 border-r flex flex-col bg-muted/20">
				...
				>
					<Logo variant="letters" className="h-[17px] w-auto" />
					<span className="text-sm font-semibold tracking-tight">Agent Pixel Hub</span>
				...
				<div className="flex-1 overflow-y-auto px-5 py-4 space-y-6">
					<div className="text-xs text-muted-foreground leading-relaxed space-y-2">
						<p>
							Agent Pixel Hub lets local apps (e.g. MCP servers) control the Page Agent extension via
							WebSocket.
						</p>
						<p>
